...
def create_pyramid(size=150, height=180):
    ...
    faces = [
        ...
        # Основание (квадрат)
        Face([0, 1, 2, 3], color='magenta')  # нижнее основание
    ]
...
def create_tetrahedron(size=150):
    ...
    vertices = [
        Point3D(0, 0, size),           # 0 - вершина
        Point3D(size, 0, -size/2),     # 1
        Point3D(-size, 0, -size/2),    # 2
        Point3D(0, h, 0)               # 3 - верхняя вершина (для пирамиды с основанием внизу)
    ]
    
    # Альтернативный вариант: пирамида с основанием внизу
    # Сделаем классический тетраэдр с основанием внизу
    vertices = [
    ...
    faces = [
        ...
        Face([0, 2, 1], color='magenta')  # основание
    ]
