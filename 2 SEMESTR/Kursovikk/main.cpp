...
// - работодателях (название, сфера деятельности, адрес, телефон и т.п.), предлагаемых вакансиях
// (наименование должности, график работы, оклад, требования по образованию и квалификации, предложения и заявки работодателей и т.д.),
