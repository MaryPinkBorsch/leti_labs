...
def response(function_call):
    if function_call.message:
        if function_call.data == "yes":
            second_mess = "Упражнения для растяжки на Ютуб смотри тут:"
            third_mess = "Начнем тренировку!"
            mess4 = "Пилатес-упражнения на Ютуб смотри тут:"
            
            mess1 = "Стрейчинг для шеи:"
            mess2 = "Стрейчинг от боли в спине:"
            mess3 = "Общая растяжка 5 мин:"
            mess44 = "Общая растяжка 10 мин:"
